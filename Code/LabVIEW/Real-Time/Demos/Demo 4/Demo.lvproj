...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Convert input device to teleop command.vi" Type="VI" URL="../Convert input device to teleop command.vi"/>
		<Item Name="Convert joystick to teleop command.vi" Type="VI" URL="../Convert joystick to teleop command.vi"/>
		<Item Name="Convert keyboard to teleop command.vi" Type="VI" URL="../Convert keyboard to teleop command.vi"/>
		<Item Name="Convert mouse to teleop command.vi" Type="VI" URL="../Convert mouse to teleop command.vi"/>
		<Item Name="Host globals (robot acquires video).vi" Type="VI" URL="../Host globals (robot acquires video).vi"/>
		<Item Name="Remote robot control (robot acquires video).vi" Type="VI" URL="../Remote robot control (robot acquires video).vi"/>
		<Item Name="Safety commands.ctl" Type="VI" URL="../Safety commands.ctl"/>
		<Item Name="Teleop command.ctl" Type="VI" URL="../Teleop command.ctl"/>
		<Item Name="Wait for UDP connection.vi" Type="VI" URL="../Wait for UDP connection.vi"/>
   ...
   <Value>/Chassis Temperature</Value>
						...
						<Property Name="FPGA.PersistentID" Type="Str">{87C59E69-A266-47AA-B046-89149766BCBD}</Property>
					</Item>
   ...
   <Value>/FPGA LED</Value>
						...
						<Property Name="FPGA.PersistentID" Type="Str">{10C11BFB-4B0E-4341-94B6-144F96763673}</Property>
					</Item>
   ...
   <Value>/Scan Clock</Value>
						...
						<Property Name="FPGA.PersistentID" Type="Str">{14069ED9-8A27-45EE-96AF-6128E2B0DF67}</Property>
					</Item>
   ...
   <Value>/Sleep</Value>
						...
						<Property Name="FPGA.PersistentID" Type="Str">{4F594BBE-653B-4598-AA91-B2A5978E4E4B}</Property>
					</Item>
   ...
   <Value>/System Reset</Value>
						...
						<Property Name="FPGA.PersistentID" Type="Str">{308A16E4-89B2-485B-A8A1-2E08E5316F73}</Property>
					</Item>
				</Item>
				<Item Name="40 MHz Onboard Clock" Type="FPGA Base Clock">
					<Property Name="FPGA.PersistentID" Type="Str">{DB33EBE4-6A7F-47EC-9358-770A11B92AE0}</Property>
				...
				<Item Name="Mod1" Type="RIO C Series Module">
					...
					<Property Name="FPGA.PersistentID" Type="Str">{449832C1-1866-4608-8CD4-E497D48C436B}</Property>
					<Item Name="Port1" Type="RIO Subresource">
						<Property Name="FPGA.PersistentID" Type="Str">{33DCBBFA-CFE6-4E68-8D1C-E9DAAE87622E}</Property>
					</Item>
					<Item Name="Port2" Type="RIO Subresource">
						<Property Name="FPGA.PersistentID" Type="Str">{72E060CE-50AE-4681-8C49-E07C50873F13}</Property>
					</Item>
					<Item Name="Port3" Type="RIO Subresource">
						<Property Name="FPGA.PersistentID" Type="Str">{04282C74-D111-4CF3-BE2E-156F0F49E749}</Property>
					</Item>
					<Item Name="Port4" Type="RIO Subresource">
						<Property Name="FPGA.PersistentID" Type="Str">{7BB1CC1C-5AF0-4951-AF0A-805CD08E91CE}</Property>
					</Item>
				</Item>
				<Item Name="Dependencies" Type="Dependencies">
		...
		<Item Name="Robot globals (robot acquires video).vi" Type="VI" URL="../Robot globals (robot acquires video).vi"/>
		<Item Name="Robot Main (robot acquires video).vi" Type="VI" URL="../Robot Main (robot acquires video).vi"/>
		<Item Name="Dependencies" Type="Dependencies"/>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
