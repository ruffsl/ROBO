...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="UniCyRO Environment Simulator" Type="Robotics Environment Simulator">
			<Item Name="UniCyRO Environment Simulator ID List.txt" Type="Document" URL="../UniCyRO Environment Simulator ID List.txt"/>
			<Item Name="UniCyRO Environment Simulator.vi" Type="VI" URL="../UniCyRO Environment Simulator.vi"/>
			<Item Name="UniCyRO Environment Simulator.xml" Type="Document" URL="../UniCyRO Environment Simulator.xml"/>
		</Item>
